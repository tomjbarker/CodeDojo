...
describe("Problem 8", function () {
    ...
    it("returns 32 given 22222", function () {
        expect(katas.largestProdOfNConsDigits("22222")).toEqual(32);
    });

    it("returns 32 given 10101001122222928273626", function () {
        expect(katas.largestProdOfNConsDigits("10101001122222928273626")).toEqual(32);
    });

    it("returns 19208 given ", function () {
