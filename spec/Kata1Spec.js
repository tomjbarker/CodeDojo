...
describe("Problem 8", function () {
	...
	it("returns 564102 given 1276652177732116012", function () {
		expect(katas.largestProdOfNConsDigits("1276652177732116012", 3)).toEqual(564102);
	});

    it("returns ??? given ", function () {
